...
my_j2_environment = jinja2.Environment(loader = jinja2.FileSystemLoader('./jinja-templates'))
...
my_yaml_cfg_file = open('./jinja-data/j2-data-01-lpbks.yml')
...
for host in my_config_data:
    ...
    config_filename =  f'./j2-config-files/{host}-config-file-1.cfg'
