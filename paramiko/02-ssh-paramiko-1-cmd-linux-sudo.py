...
HOST="10.99.99.100"
# the policy is a predefined subclass of paramiko.client and says what to do 
# when presented with unknown certs from other end.
...
# jack,jill,jo=ssh_connection_1.exec_command("ls", timeout=5) shows that you
# can call the what you want.
stdin,stdout,stderr=ssh_connection_1.exec_command("sudo -S whoami", timeout=5)
stdin.write('Ilovenetworks99\n')
